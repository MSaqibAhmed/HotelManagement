          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <LazyImage src={image2} alt="Hotel Interior" className="w-full h-56" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-lg mt-8">
                <LazyImage src={image3} alt="Hotel Service" className="w-full h-56" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="rounded-2xl overflow-hidden shadow-md col-span-2 row-span-1">
              <LazyImage src={image1} alt="Pool" className="w-full h-60" />
            </div>
            <div className="rounded-2xl overflow-hidden shadow-md">
              <LazyImage src={image2} alt="Room" className="w-full h-60" />
            </div>
            <div className="rounded-2xl overflow-hidden shadow-md">
              <LazyImage src={image3} alt="Service" className="w-full h-48" />
            </div>
            <div className="rounded-2xl overflow-hidden shadow-md col-span-2">
              <LazyImage src={image1} alt="Lounge" className="w-full h-48" />
            </div>
          </div>
        </div>
      </AnimatedSection>
